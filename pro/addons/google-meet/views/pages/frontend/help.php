...
$items = array(
	...
	array(
		'title'   => esc_html__( 'How do I create a Live Lesson on Qalam LMS?', 'tutor-pro' ),
	...
	array(
		...
		'content' => __( 'You can notify students about live lessons using Email Notifications of Qalam LMS and from the Google Meet settings on Qalam LMS frontend and backend.', 'tutor-pro' ),
	),
	array(
		'title'   => __( 'Do I need a Google account to integrate Google Meet with Qalam LMS?', 'tutor-pro' ),
