...
<div class="tutor-google-meet-settings-content">
	<div class="tutor-admin-container tutor-admin-container-sm">
		<div>
			<div class="tutor-fs-4 tutor-fw-medium tutor-mb-20"><?php esc_html_e( 'Settings', 'tutor-pro' ); ?></div>
						...
						<div class="tutor-d-flex tutor-mt-24">
							...
							<?php if ( 'dropdown' === $settings['type'] ) : ?>
								<div class="tutor-col-md-8 tutor-mb-md-0 tutor-mb-16">
									<select name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $settings['name'] ); ?>" class="tutor-form-select" data-searchable data-value="<?php echo esc_attr( isset( $user_settings[ $name ] ) ? $user_settings[ $name ] : '' );  ?>">
