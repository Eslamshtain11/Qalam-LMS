...
<div class="tutor-google-meet-consent-screen">
	<div class="tutor-card <?php echo qalam_220_is_admin_surface_context( 'google_meet' ) ? 'tutor-card-no-border' : ''; ?> tutor-text-center tutor-px-md-56 tutor-pt-md-72 tutor-pb-md-80 tutor-p-36">
