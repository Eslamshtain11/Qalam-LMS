...
<div class="tutor-zoom-api-container">
	...
	<form id="tutor-zoom-settings" action="">
		...
		<div class="tutor-zoom-form-container <?php echo qalam_220_is_admin_surface_context( 'zoom' ) ? 'tutor-p-20 tutor-p-xl-40' : 'tutor-pt-40'; ?>">
					...
					<div class="tutor-mb-32">
						...
						<?php if ( qalam_220_is_admin_surface_context( 'zoom' ) ) : ?>
							<div class="tutor-mt-12">
								جهّز بيانات Server-to-Server OAuth من <a href="https://marketplace.zoom.us/develop/create" target="_blank" rel="noopener noreferrer">Zoom App Marketplace</a>، وبعدها أدخل معرّف الحساب ومعرّف العميل والرمز السري بالأسفل.
							</div>
						<?php endif; ?>
					</div>
