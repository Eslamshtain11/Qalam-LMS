...
$themeum_url = 'https://tutorlms.com/docs/tutor-lms-settings-email/';
...
$items = array(
	array(
		...
		'content' => sprintf(
			...
			__(
				'To connect Zoom with your eLearning website powered by Qalam LMS, first create an app on Zoom. Then create a JWT app, copy the API credentials, and paste them into %s.',
				'tutor-pro'
			),
			'<strong>' . esc_html__( 'WP Admin > Qalam LMS > Zoom > Set API', 'tutor-pro' ) . '</strong>'
		),
	),
	array(
		'title'   => __( 'How Do I Create a Live Lesson on Qalam LMS?', 'tutor-pro' ),
		'content' => sprintf(
