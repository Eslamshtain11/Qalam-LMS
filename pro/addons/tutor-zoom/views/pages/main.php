...
<div class="<?php echo qalam_220_is_admin_surface_context( 'zoom' ) ? 'tutor-admin-wrap' : ''; ?>">
	...
	<div class="<?php echo qalam_220_is_admin_surface_context( 'zoom' ) ? 'tutor-admin-container tutor-admin-container-lg' : ''; ?>">
		<?php
			$frontend_class = ! qalam_220_is_admin_surface_context( 'zoom' ) ? 'tutor-zoom-frontend' : '';
		if ( $error_msg ) :
			?>
