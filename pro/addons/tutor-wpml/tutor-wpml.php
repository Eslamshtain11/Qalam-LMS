...
Description: Qalam LMS will make compatible with WPML
Author: Themeum
Version: 1.0.0
...
function tutor_wpml_config( $config ) {
	$newConfig   = array(
		'name'               => __( 'WPML', 'tutor-pro' ),
		'description'        => __( 'Create multilingual courses, lessons, dashboard and more.', 'tutor-pro' ),
