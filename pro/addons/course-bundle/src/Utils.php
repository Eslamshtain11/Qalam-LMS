...
class Utils {
	...
	public static function current_user_can_create_bundle(): bool {
		return (bool) current_user_can( tutor()->instructor_role ) || current_user_can( 'administrator' ) || current_user_can( 'qalam_manage_addons' );
	}
	...
	public static function current_user_can_update_bundle( int $bundle_id ): bool {
		$can = current_user_can( 'administrator' ) || current_user_can( 'qalam_manage_addons' );
		if ( ! $can ) {
