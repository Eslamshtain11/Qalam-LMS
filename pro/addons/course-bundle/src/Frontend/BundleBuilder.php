...
class BundleBuilder {
	...
	public static function update_course_bundle() {
		...
		$is_admin  = current_user_can( 'administrator' ) || current_user_can( 'qalam_manage_addons' );
		...
		if ( 'save_course_as_draft' === $submit_action ) {
			...
			if ( $can_publish_course || current_user_can( 'administrator' ) || current_user_can( 'qalam_manage_addons' ) ) {
