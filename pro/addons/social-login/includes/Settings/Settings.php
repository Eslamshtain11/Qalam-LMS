				...
				'fields'     => array(
					...
					array(
						...
						'desc'        => sprintf(
							...
							'<strong>' . esc_html__( 'Google Client ID', 'tutor-pro' ) . '</strong>'
						) . $copy_btn,
			...
			'fields'     => array(
				...
				array(
					...
					'desc'        => sprintf(
						...
						'<a href="https://developers.facebook.com/docs/facebook-login/" target="_blank">' . esc_html__( 'Facebook App ID', 'tutor-pro' ) . '</a>'
					) . $copy_btn,
		...
		$twitter = array(
			...
			'fields'     => array(
				...
				array(
					...
					// Translators: %s documentation link.
						esc_html__( 'Enter your %s here.', 'tutor-pro' ),
						'<strong>' . esc_html__( 'Twitter App Key', 'tutor-pro' ) . '</strong>'
					),
				...
				array(
					...
					// Translators: %s documentation link.
						esc_html__( 'Enter your %s here.', 'tutor-pro' ),
						'<strong>' . esc_html__( 'Twitter App Key Secret', 'tutor-pro' ) . '</strong>'
					) . $twitter_copy_btn,
