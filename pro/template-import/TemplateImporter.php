...
class TemplateImporter {
	...
	public function template_dependency() {
		...
		if ( empty( $this->template_import_dependency_api ) ) {
			return $dependent_plugins;
		}

		$response = wp_safe_remote_get( $this->template_import_dependency_api, array( 'timeout' => 15, 'redirection' => 1, 'sslverify' => true ) );
