...
use TutorPro\TemplateImport\TemplateImporter;

$is_droip_active = ( new TemplateImporter() )->is_droip_active();
...
<div class="tutor-admin-wrap">
	<div class="tutor-admin-container tutor-admin-container-lg tutor-template-import-wrapper">
		<div class="tutor-template-import-area">
				...
				<div class="tutor-template-import-area-left tutor-d-flex tutor-gap-1">
					...
					<div>
						<div class="tutor-template-top-left-heading tutor-fs-5 tutor-fw-medium">
							<?php esc_html_e( 'Themes', 'tutor-pro' ); ?>
						</div>
						<div class="tutor-template-area-left-text tutor-fs-6 tutor-fw-regular">
							<?php
							$kirki_website_link = 'https://kirki.com/';
							printf(
								wp_kses(
									/* translators: %s is the linked Kirki Pro text. */
									__( 'These themes are built with %s. It will be installed automatically when you import a theme. License not included.', 'tutor-pro' ),
									array(
										'a' => array(
											'href'   => array(),
											'target' => array(),
								...
								sprintf(
									...
									esc_url( $kirki_website_link ),
									esc_html__( 'Kirki Pro', 'tutor-pro' )
								)
							);
							?>
						</div>
			...
			<?php
				require_once tutor_pro()->path . 'templates/template-import/template-list.php';
			?>
		</div>
			...
			<div class="tutor-template-preview-frame">
				<div class="tutor-template-preview-frame-header">
					<div class="tutor- tutor-d-flex tutor-gap-1 tutor-align-center tutor-template-preview-modal-back-link">
						...
						<div><?php esc_html_e( 'Themes', 'tutor-pro' ); ?></div>
					</div>
					...
					<div class="tutor-template-preview-import-area tutor-flex-column tutor-justify-center tutor-gap-1">
						<div class="tutor-template-preview-template-details">
							...
							<p class="tutor-droip-color-presets-heading" style="display: none;">
								<?php esc_html_e( 'Choose your color palette and continue with your design', 'tutor-pro' ); ?>
							</p>
							...
							<?php if ( tutor()->has_pro ) { ?>
								<div class="tutor-include-demo-courses-toggle tutor-d-flex">
									<input id="tutor-include-courses-checkbox" class="tutor-form-check-input" type="checkbox" checked>
									<input type="hidden" id="tutor_template_course_data_url">
									<label for="tutor-include-courses-checkbox"><?php esc_html_e( 'Include Qalam LMS demo courses', 'tutor-pro' ); ?></label>
								</div>
							<?php } ?>
							<div class="tutor-template-import-btn-wrapper">
								<button class="tutor-template-import-btn tutor-btn tutor-btn-primary tutor-btn-sm tutor-justify-center" <?php echo $is_droip_active ? 'disabled' : ''; ?> >
		...
		<div class="tutor-template-consent-modal">
			<div class="tutor-template-consent-modal-overlay"></div>
			<div class="tutor-template-consent-modal-content">
				<button class="tutor-template-consent-modal-close" type="button" aria-label="<?php esc_attr_e( 'Close', 'tutor-pro' ); ?>">
					<span class="tutor-icon-times" aria-hidden="true"></span>
				</button>
				<h4 class="tutor-template-consent-modal-title">
					<?php esc_html_e( "Hi, you're importing a Tutor theme for the first time.", 'tutor-pro' ); ?>
				</h4>
				<div class="tutor-template-consent-modal-subtitle">
					<?php esc_html_e( "Here's what will happen:", 'tutor-pro' ); ?>
				</div>
				<ul class="tutor-template-consent-modal-list">
					<li><?php esc_html_e( 'Tutorbase theme will be installed', 'tutor-pro' ); ?></li>
					<li><?php esc_html_e( 'Kirki & Kirki Pro will be installed', 'tutor-pro' ); ?></li>
					<li><?php esc_html_e( 'Kirki Pro license is required to customize themes', 'tutor-pro' ); ?></li>
				</ul>
				<div class="tutor-template-consent-modal-check">
					<input id="tutor-template-consent-checkbox" class="tutor-form-check-input" type="checkbox">
					<label for="tutor-template-consent-checkbox">
						<?php esc_html_e( 'I agree and consent to the above', 'tutor-pro' ); ?>
					</label>
				</div>
				<div class="tutor-template-consent-progress" style="display: none;">
					<div class="tutor-template-consent-progress-header">
						<div class="tutor-template-consent-progress-title">
							<?php esc_html_e( 'Import in progress', 'tutor-pro' ); ?>
						</div>
						<div class="tutor-template-consent-progress-percent">0%</div>
					</div>
					<div class="tutor-template-consent-progress-bar">
						<div class="tutor-template-consent-progress-bar-inner" style="width: 0%;"></div>
					</div>
					<div class="tutor-template-consent-progress-status">
						<?php esc_html_e( 'Now happening...', 'tutor-pro' ); ?>
					</div>
				</div>
				<div class="tutor-template-consent-modal-actions">
					<button class="tutor-template-consent-cancel tutor-btn tutor-btn-sm" type="button">
						<?php esc_html_e( 'Not now', 'tutor-pro' ); ?>
					</button>
					<button class="tutor-template-consent-import-btn tutor-btn tutor-btn-primary tutor-btn-sm" type="button" disabled>
						<i class="tutor-icon-import tutor-mr-8"></i>
						<?php esc_html_e( 'Import', 'tutor-pro' ); ?>
					</button>
				</div>
