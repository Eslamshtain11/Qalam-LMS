	...
	<div class="tutor-admin-container tutor-admin-container-lg tutor-mb-24">
		<div class="tutor-card tutor-p-24">
			<div class="tutor-row tutor-align-lg-center">
				...
				<div class="tutor-col-lg-auto qalam-announcement-actions">
					...
					<a class="tutor-btn tutor-btn-outline-primary tutor-btn-lg" href="<?php echo esc_url( admin_url( 'admin.php?page=qalam-video-ads' ) ); ?>">إعلان فيديو</a>
				</div>
			</div>
		</div>
	</div>
