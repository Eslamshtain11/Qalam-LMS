...
$tutor_pricing_page = admin_url( 'admin.php?page=tutor-addons' );
$tutor_home_page    = admin_url( 'admin.php?page=tutor' );
$asset_base         = 'https://tutor-lms.s3.us-east-1.amazonaws.com/whats-new/';

$action_button_text = __( 'Open Qalam LMS', 'tutor' );
...
$render_action_button = function ( $text, $pro_url = '' ) use ( $has_pro, $tutor_pricing_page, $tutor_home_page ) {
	...
	?>
	<a href="<?php echo esc_url( $url ); ?>" class="tutor-section-action">
		...
		<section class="tutor-section-wrapper tutor-section-learner">
			<div class="tutor-section-title">
				...
				<div class="tutor-section-title-right">
					...
					<div>
						<?php $render_action_button( $action_button_text, admin_url( 'admin.php?page=create-course' ) ); ?>
					</div>
				</div>
			</div>
	...
	<div class="tutor-section-bg tutor-section-bg-interactive">
		<div class="tutor-section-layout">
			...
			<div class="tutor-section-title">
				...
				<div class="tutor-section-title-right">
					<p><?php esc_html_e( 'Most LMSs treat assessment as the boring part. Qalam LMS 4.0 turns it into the part students look forward to — with five new interactive quiz types designed to keep them engaged.', 'tutor' ); ?></p>
					<div>
						<?php $render_action_button( $action_button_text, admin_url( 'admin.php?page=qalam-quiz-builder' ) ); ?>
					</div>
				</div>
			</div>
