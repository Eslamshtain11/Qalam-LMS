...
$qalam_managed_shell = ! $is_by_short_code && ! defined( 'OTLMS_VERSION' ) && function_exists( 'qalam_240_render_shell_header' );
if ( $qalam_managed_shell ) {
	if ( ! defined( 'QALAM_260_DASHBOARD_SHELL' ) ) { define( 'QALAM_260_DASHBOARD_SHELL', true ); }
	qalam_240_render_shell_header();
} elseif ( ! $is_by_short_code && ! defined( 'OTLMS_VERSION' ) ) {
	?>
	<!DOCTYPE html>
