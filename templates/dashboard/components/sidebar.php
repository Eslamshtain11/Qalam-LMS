...
<div class="tutor-dashboard-sidebar">
	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="tutor-dashboard-sidebar-logo qalam-student-brand" aria-label="<?php esc_attr_e( 'Qalam LMS', 'tutor' ); ?>">
		<img src="<?php echo esc_url( plugin_dir_url( TUTOR_FILE ) . 'assets/images/qalam-logo.svg' ); ?>" alt="Qalam LMS">
		<span class="qalam-student-brand-copy">
			<strong>قلم</strong>
			<small>مساحتك للتعلّم</small>
		</span>
	</a>
