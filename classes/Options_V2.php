					...
					array(
						...
						'fields'     => array(
							...
							array(
								...
								'label_title' => '',
								'default'     => 'off',
								'desc'        => __( 'Enable this option to use Qalam LMS video player for YouTube.', 'tutor' ),
							),
							array(
								...
								'label_title' => '',
								'default'     => 'off',
								'desc'        => __( 'Enable this option to use Qalam LMS video player for Vimeo.', 'tutor' ),
							),
						),
					),
				),
					...
					array(
						...
						'fields'     => array(
							...
							array(
								...
								'type'        => 'toggle_switch',
								'label'       => __( 'Enable Qalam LMS Login', 'tutor' ),
								'label_title' => '',
								'default'     => 'on',
								'desc'        => __( 'Enable to use the Qalam LMS native login system instead of the WordPress login page', 'tutor' ),
							),
							array(
