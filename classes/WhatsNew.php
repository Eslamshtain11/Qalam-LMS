...
class WhatsNew {
	...
	private function get_plugin_version_info() {
		$remote_version    = QALAM_LMS_UI_VERSION;
		$installed_version = QALAM_LMS_UI_VERSION;
	...
	public static function render_item( $type, $log ) {
		$obj = (object) $log;
		?>
		<li class="tutor-fs-7"><strong><?php echo esc_html( array( 'New' => 'جديد', 'Update' => 'تحسين', 'Fix' => 'إصلاح' )[ $type ] ?? $type ); ?>:</strong> <span><?php echo esc_html( $obj->title ); ?></span> 
		<?php
