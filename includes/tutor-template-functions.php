...
if ( ! function_exists( 'tutor_get_template' ) ) {
	...
	function tutor_get_template( $template = null, $tutor_pro = false ) {
		...
		if ( ! file_exists( $template_location ) ) {
			...
			if ( ! file_exists( $template_location ) ) {
				$warning_msg = __( 'The file you are trying to load does not exist in your theme or Qalam LMS plugin location. If you are extending the Qalam LMS plugin, please create a php file here: ', 'tutor' );
