...
if ( ! function_exists( 'get_tutor_header' ) ) {
	...
	function get_tutor_header( $full_screen = false ) {
		if ( function_exists( 'qalam_240_render_shell_header' ) && function_exists( 'qalam_240_is_public_surface' ) && qalam_240_is_public_surface() && ( ! function_exists( 'qalam_240_is_login_surface' ) || ! qalam_240_is_login_surface() ) ) {
...
if ( ! function_exists( 'get_tutor_footer' ) ) {
	...
	function get_tutor_footer( $full_screen = false ) {
		if ( function_exists( 'qalam_240_render_shell_footer' ) && function_exists( 'qalam_240_is_public_surface' ) && qalam_240_is_public_surface() && ( ! function_exists( 'qalam_240_is_login_surface' ) || ! qalam_240_is_login_surface() ) ) {
